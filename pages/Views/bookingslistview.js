            ...
            <table className="min-w-full bg-bgrnd-0 space-y-10 gap-10 rounded-lg shadow-md">
              ...
              <tbody>
                {safeBookings.length === 0 ? (
                  <tr>
                    <td colSpan="2" className="py-4 px-4 w-screen  items-start justify-center text-hdline-0 text-center">
                   <div class="mx-auto w-full max-w-sm rounded-md border border-bgrnd-0 p-4">
